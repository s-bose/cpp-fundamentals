// Generated by Bisonc++ V6.04.01 on Sun, 10 Apr 2022 18:08:44 +0530
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 1}, // 1: separated ->  sep
     {259, 3}, // 2: sep (',') ->  sep ',' WORD
     {259, 1}, // 3: sep (WORD) ->  WORD
     {260, 1}, // 4: separated_$ ->  separated
};
