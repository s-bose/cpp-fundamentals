// Generated by Bisonc++ V6.04.01 on Mon, 11 Apr 2022 00:27:00 +0530
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 1}, // 1: line ->  plain
     {258, 1}, // 2: line ->  separated
     {258, 0}, // 3: line ->  <empty>
     {259, 2}, // 4: plain (WORD) ->  plain WORD
     {259, 1}, // 5: plain (WORD) ->  WORD
     {260, 2}, // 6: separated (WORD) ->  word_comma WORD
     {261, 2}, // 7: word_comma (WORD) ->  WORD ','
     {261, 2}, // 8: word_comma (',') ->  separated ','
     {262, 1}, // 9: line_$ ->  line
};
