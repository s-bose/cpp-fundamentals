// Generated by Bisonc++ V6.04.01 on Thu, 07 Apr 2022 01:35:30 +0530
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 1}, // 1: startrule ->  write_stmt
     {260, 0}, // 2: startrule ->  <empty>
     {261, 3}, // 3: write_stmt (';') ->  write body ';'
     {262, 1}, // 4: write (WRITE) ->  WRITE
     {263, 3}, // 5: body ('(') ->  '(' var_list ')'
     {264, 3}, // 6: var_list (',') ->  var_list ',' var_name
     {264, 1}, // 7: var_list ->  var_name
     {265, 1}, // 8: var_name (IDENT) ->  IDENT
     {265, 1}, // 9: var_name (NUMBER) ->  NUMBER
     {266, 1}, // 10: startrule_$ ->  startrule
};
