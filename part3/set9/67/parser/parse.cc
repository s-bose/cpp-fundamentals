// Generated by Bisonc++ V6.04.01 on Sun, 17 Apr 2022 02:58:10 +0530
...
#line 37 "parser/grammar"
        {
         showString(vs_(0).get<Tag_::T_STRING>());
         }
        break;

        case 5:
#line 42 "parser/grammar"
        {
         showDouble(vs_(0).get<Tag_::T_DOUBLE>());
         }
        break;
