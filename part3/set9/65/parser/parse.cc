// Generated by Bisonc++ V6.04.01 on Sun, 17 Apr 2022 00:23:56 +0530
...
PI_ const s_productionInfo[] = 
{
     ...
     {265, 1}, // 6: expr (NUMBER) ->  NUMBER
     {265, 1}, // 7: expr (IDENT) ->  IDENT
     {265, 2}, // 8: expr (uMinus) ->  '-' expr
     {265, 3}, // 9: expr ('^') ->  expr '^' expr
     {265, 3}, // 10: expr ('|') ->  expr '|' expr
     {265, 3}, // 11: expr ('&') ->  expr '&' expr
     {265, 3}, // 12: expr ('<') ->  expr '<' expr
     {265, 3}, // 13: expr ('>') ->  expr '>' expr
     {265, 3}, // 14: expr ('+') ->  expr '+' expr
     {265, 3}, // 15: expr ('-') ->  expr '-' expr
     {265, 3}, // 16: expr ('*') ->  expr '*' expr
     {265, 3}, // 17: expr ('/') ->  expr '/' expr
     {265, 3}, // 18: expr ('%') ->  expr '%' expr
     {265, 3}, // 19: expr ('(') ->  '(' expr ')'
     {265, 3}, // 20: expr ('=') ->  expr '=' expr
     {265, 3}, // 21: expr (OP_ASSIGN) ->  expr OP_ASSIGN expr
     {265, 3}, // 22: expr (OP_LOGIC) ->  expr OP_LOGIC expr
     {265, 3}, // 23: expr (OP_SHIFT) ->  expr OP_SHIFT expr
     {266, 1}, // 24: lines_$ ->  lines
};
...
#line 82 "parser/grammar"
        ...
        case 12:
#line 87 "parser/grammar"
        {
         OpLesser(vs_(-2), vs_(0));
         }
        break;

        case 13:
#line 92 "parser/grammar"
        {
         opGreater(vs_(-2), vs_(0));
         }
        break;
...
#line 128 "parser/grammar"
        ...
        case 21:
#line 133 "parser/grammar"
        {
         d_val_ = opAssignOthr(vs_(-1), vs_(-2), vs_(0));
         }
        break;

        case 22:
#line 138 "parser/grammar"
        {
